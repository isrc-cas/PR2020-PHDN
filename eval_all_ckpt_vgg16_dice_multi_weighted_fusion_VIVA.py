...
tf.app.flags.DEFINE_string('checkpoint_path', '../model/hand_vgg16_dice_multi_rbox_R01_VIVA_aug_weighted_fusion/', '')
tf.app.flags.DEFINE_string('output_dir', '../result/VIVA-test-result/pos/', '')#'/tmp/ch4_test_images/images/'
tf.app.flags.DEFINE_string('heatmap_output_dir', '../result/VIVA-test-result/heatmaps_vgg16_dice_multi_VIVA/', '')
    ...
    with tf.get_default_graph().as_default():
        ...
        with tf.Session(config=config) as sess:
            ...
            for checkpoint in checkpoints[1:]:#
                ...
                out_name = FLAGS.output_dir+'VIVA-aug-vgg16-dice-multi-weighted-fusion-'+global_step+'.txt'
