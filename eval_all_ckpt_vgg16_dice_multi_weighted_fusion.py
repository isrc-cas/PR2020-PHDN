...
tf.app.flags.DEFINE_string('test_data_path', '../data/Oxford/test/', '')
tf.app.flags.DEFINE_string('gpu_list', '0', '')
tf.app.flags.DEFINE_string('checkpoint_path', '/data/Diana/model/hand_vgg16_dice_multi_rbox_R01_oxford_aug_weighted_fusion/', '')
tf.app.flags.DEFINE_string('output_dir', '../result/oxford-test-result/pos/', '')#'/tmp/ch4_test_images/images/'
tf.app.flags.DEFINE_string('heatmap_output_dir', '../result/oxford-test-result/heatmaps_vgg16_dice_multi_oxford/', '')
    ...
    with tf.get_default_graph().as_default():
        ...
        with tf.Session(config=config) as sess:
            ...
            for checkpoint in checkpoints[1:]:#
                ...
                out_name = FLAGS.output_dir+'oxford-aug-vgg16-dice-multi-weighted-fusion-'+global_step+'.txt'
