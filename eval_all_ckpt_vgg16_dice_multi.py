...
tf.app.flags.DEFINE_string('checkpoint_path', '../model/hand_vgg16_dice_multi_rbox_R01_oxford_aug/', '')
    ...
    with tf.get_default_graph().as_default():
        ...
        with tf.Session(config=config) as sess:
            ...
            for checkpoint in checkpoints:#
                ...
                out_name = FLAGS.output_dir+'oxford-aug-vgg16-dice-multi-'+global_step+'.txt'
