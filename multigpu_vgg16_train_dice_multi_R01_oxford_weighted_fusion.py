...
tf.app.flags.DEFINE_string('pretrained_model_path', '../model/vgg16/vgg_16.ckpt', '')
...
def tower_loss(images, score_maps, geo_maps, training_masks, reuse_variables=None):
    ...
    # print f_score[0].shape, f_score[1].shape
    # print f_geometry[0].shape, f_geometry[1].shape
    # single scale
