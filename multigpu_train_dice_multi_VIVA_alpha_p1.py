...
tf.app.flags.DEFINE_string('checkpoint_path', '../model/hand_resnet_v1_50_dice_multi_VIVA_aug_rbox_alpha_p1/', '')
...
import resnet_v1_model_dice_multi_alpha_p1 as model
