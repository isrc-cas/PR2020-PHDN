...
CKPT_PATH = '../model/hand_resnet_v1_50_dice_multi_oxford_aug_rbox/model.ckpt-158081'#None#
heatmaps = []
...
def main(argv=None):
    ...
    with tf.get_default_graph().as_default():
        ...
        with tf.Session(config=config) as sess:
            ...
            with open(FLAGS.output_dir+'oxford-'+str(MAX_SIDE_LEN)+'-dice-multi-aug-' +global_step+'.txt', 'w') as f:
                ii = 0
