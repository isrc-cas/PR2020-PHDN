...
import random
from image_augmentation import random_hsv_transform, random_flip_left_right

import tensorflow as tf

from data_util import GeneratorEnqueuer

tf.app.flags.DEFINE_string('training_data_path', '../data/VIVA/train/',
    ...
    while True:
        ...
        for i in index:
            try:
                ...
                #augmentation  1
                im = random_hsv_transform(im, 5, 0.5, 0.5)
